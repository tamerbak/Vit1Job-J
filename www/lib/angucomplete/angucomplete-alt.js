...
(function (root, factory) {
  ...
  angular.module('angucomplete-alt', ['validationDataServices']).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', 'Validator', function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate, Validator) {
    // keyboard events
    var KEY_DW  = 40;
    var KEY_RT  = 39;
    var KEY_UP  = 38;
